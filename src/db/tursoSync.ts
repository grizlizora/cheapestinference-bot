...
export class TursoCloudSync {
  ...
  public async pullStateFromTurso(db: Database.Database): Promise<void> {
    ...
    try {
      ...
      console.log(`✅ [TursoSync] Hydrated ${loadedUsers} users, ${loadedSubs} subscriptions from Turso Cloud in ${elapsed}ms`);
    } catch (err: any) {
  ...
  public async flush(): Promise<void> {
    ...
    try {
      ...
      // Put failed mutations back into queue for retry
